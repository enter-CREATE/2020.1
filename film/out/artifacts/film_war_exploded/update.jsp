...
<div class="container">
    ...
    <form action="/filminfo/film?operator=update" class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="${film.ukName}" name="ukname" id="ukname"
                       placeholder="请输入电影名称">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="${film.nickName}" name="nickname" id="nickname"
                       placeholder="请输入风格">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="${film.tinyImg}" name="tinyimg" id="img"
                       placeholder="请输入图片地址">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" value="${film.attackPower}" name="attackpower" id="ak"
                       placeholder="请输入评价人数">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" value="${film.handHard}" max="10" name="handhard" id="hh"
                       placeholder="请输入评分">
            </div>
        </div>
