...
<div class="container">
    ...
    <form action="/lolhero/hero?operator=update" class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="${hero.ukName}" name="ukname" id="ukname"
                       placeholder="请输入英雄名称">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="${hero.nickName}" name="nickname" id="nickname"
                       placeholder="请输入昵称">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="${hero.tinyImg}" name="tinyimg" id="img"
                       placeholder="请输入图片地址">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" value="${hero.attackPower}" name="attackpower" id="ak"
                       placeholder="请输入攻击力">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" value="${hero.handHard}" max="10" name="handhard" id="hh"
                       placeholder="请输入上手难度">
            </div>
        </div>
